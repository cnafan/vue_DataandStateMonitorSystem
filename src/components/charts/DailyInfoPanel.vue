...
<!--    :key="new Date().getUTCMilliseconds()"-->
    <div style="height:100%;display: flex;flex-direction: column;">
      ...
      <div style="margin-left:10px;margin-top:20px;flex:2;display: flex;padding:20px;">
        <div style="flex: 1">
...
export default {
  ...
  watch: {
    ...
    allSystemInfo: function () {
      ...
      this.configAllSystemInfo.series[0].data = []
      this.configAllSystemInfo.series[0].data.push({
        name: '系统管理控制软件',
      ...
      this.configAllSystemInfo.series[0].data.push({name: 'VLBI站控软件', value: this.allSystemInfo['VLBISoftware']})
      this.configAllSystemInfo.series[0].data.push({
        name: '原子钟信号监测软件',
      ...
      if (this.allSystemInfo['SystemManageSoftware'] === 0 && this.allSystemInfo['SatIntegratedSoftware'] === 0 && this.allSystemInfo['StateMonitorSoftware'] === 0 &&
        ...
        this.configAllSystemInfo.series[0].data.push({name: 'GNSS时差数据处理软件', value: 1})
      } else {
        this.configAllSystemInfo.series[0].data.push({
          name: 'GNSS时差数据处理软件',
      ...
      this.configAllSystemInfo = {...this.configAllSystemInfo}
    }
  },
  data () {
    return {
