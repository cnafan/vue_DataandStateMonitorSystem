<template>
  <dv-border-box-7>
    <div style="height:100%;overflow: hidden">
      ...
      <dv-scroll-board style="overflow: hidden" id="runtimeScrollBoard" :config="getScrollBoardConfig" ref="scrollBoard"/>
    </div>
  </dv-border-box-7>
</template>
<script>
...
export default {
  ...
  methods: {
    init(){
      scrollBoard = document.getElementById('scrollBoard');
