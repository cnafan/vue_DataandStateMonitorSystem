<template>
  <dv-border-box-5>
    ...
    <div class="split-system-board" style="display: flex;overflow-x: hidden">
      ...
      <!--      </div>-->
      <div>
        <dv-active-ring-chart :config="option1" style="width:200px;height:200px"/>
        <div class="each-system-info"> 系统管理控制软件</div>
      </div>
      <div>
        <dv-active-ring-chart :config="option2" style="width:200px;height:200px"/>
        <div class="each-system-info"> 卫星综合管理软件</div>
      </div>
      <div>
        <dv-active-ring-chart :config="option3" style="width:200px;height:200px"/>
        <div class="each-system-info"> 状态监测及告警软件</div>
      </div>
    </div>
    <div class="split-system-board" style="display: flex;">
      <div>
        <dv-active-ring-chart :config="option4" style="width:200px;height:200px"/>
        <div class="each-system-info"> VLBI站控软件</div>
      </div>
      <div>
        <dv-active-ring-chart :config="option5" style="width:200px;height:200px"/>
        <div class="each-system-info"> 原子钟信号监测软件</div>
      </div>
      <div>
        <dv-active-ring-chart :config="option6" style="width:200px;height:200px"/>
