...
<!--    </div>-->
<!--    <div id="myDiagramDiv"-->
<!--         style="pointer-events: auto;width: 550px; height: 100%; display: inline-block; vertical-align: top; position: relative; -webkit-tap-highlight-color: rgba(255, 255, 255, 0); cursor: auto;">-->
<!--      <canvas tabindex="0"-->
<!--              style="position: absolute; top: 0; left: 0; z-index: 2; user-select: none;  height: 548px; cursor: auto;">-->
<!--        This text is displayed if your browser does not support the Canvas HTML element.-->
<!--      </canvas>-->
<!--      &lt;!&ndash;            <div style="position: absolute; overflow: auto; width: 100%; height: 100%; z-index: 1;">&ndash;&gt;-->
<!--      &lt;!&ndash;              <div style="position: absolute; width: 1px; height: 1px;"></div>&ndash;&gt;-->
<!--      &lt;!&ndash;            </div>&ndash;&gt;-->
<!--    </div>-->
<!--    &lt;!&ndash;        </el-card>&ndash;&gt;-->
<!--    &lt;!&ndash;    <div id="infobox"&ndash;&gt;-->
<!--    &lt;!&ndash;         style="display: inline-block; vertical-align: top; width: 256px; background: #757575; color: #FFF; padding: 20px;">&ndash;&gt;-->
<!--    &lt;!&ndash;      <img id="Image" width="216" alt="" src="">&ndash;&gt;-->
<!--    &lt;!&ndash;      <h3 id="Title"></h3>&ndash;&gt;-->
<!--    &lt;!&ndash;      <p id="Description">Select a node to see more information.</p>&ndash;&gt;-->
<!--    &lt;!&ndash;    </div>&ndash;&gt;-->
<!--    &lt;!&ndash;    <div style="margin-top: 300px">&ndash;&gt;-->
<!--    &lt;!&ndash;      <v-chart :options="pie"></v-chart>&ndash;&gt;-->
<!--    &lt;!&ndash;    </div>&ndash;&gt;-->
<!--  </dv-border-box-5>-->
<!--</template>-->
