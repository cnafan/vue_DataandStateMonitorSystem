...
function onConnected() {
    let queueName = [
        'BDSBroadcastClockDifference', 'BDSClockCorrection', 'BDSClockDifference',
        ...
        'BDNavAll', 'NavAll',
        'WorkingStateOrientationAntenna',
        'sending info', 'receiving info',
        'connect info',
        'alert notify'
        // 'realTimeView',
    ]
...
function queuePush(software, data) {
    ...
    switch (software) {
        ...
        case 'BDSignalComponent':
            // console.log('bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb:', new Date().getUTCMilliseconds())
            // console.log('bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb:', new Date().getMilliseconds())
            // console.log('bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb:', new Date().getTime().toString())
            store.commit('change', {'data': data, 'software': software})
            break
        case 'BDNavAll':
            store.commit('change', {
        ...
        case 'NavAll':
            ...
            store.commit('change', {
                'data': data['SignalComponentAllDirection'],
                'software': 'SignalComponentAllDirection'
            })
            // store.commit('addRuntimeScrollBoard', {'name': getSoftwareChineseName(software), 'time': getCurrentTime()})
            break
        case 'WorkingStateInfo':
        ...
        case 'WorkingStateOrientationAntenna':
            // console.log('WorkingStateOrientationAntenna', typeof data['workingStateInfoSat'])
            // console.log('WorkingStateOrientationAntenna', typeof data['workingStateDirection'])
            // console.log('WorkingStateOrientationAntenna', data['workingStateDirection'])
            store.commit('change', {'data': data, 'software': software})
            break
